// Перенесено из z3n7/Requests/Rqst.cs. Копия дословная.
//
// Своей копии класса у нас не было: GET/POST/PUT/DELETE в ZennoStub.cs были
...
namespace z3n7
{
    public class Rqst
    {
        ...
        private class Request
        {
            ...
            public string Source { get; set; } = "z3n7";
        }
        #endregion
        ...
        {
            var netHttp = new NetHttp(_project, log: null);
