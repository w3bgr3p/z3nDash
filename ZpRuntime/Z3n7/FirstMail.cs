// Перенесено из z3n7/Api/FirstMail.cs. Копия дословная.
//
// Наш Api/FirstMail.cs удалён — это был разошедшийся форк того же класса:
// без GetOne/GetAll/GetOTP/GetLink/Otp и с другой сборкой строки авторизации
