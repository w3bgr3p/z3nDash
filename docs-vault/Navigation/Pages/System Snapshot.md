...
`Capture Now` запускает сбор на машине, где работает z3nDash. Снимок включает секции, которые фактически смог собрать backend: процессы, сеть и системные данные.
